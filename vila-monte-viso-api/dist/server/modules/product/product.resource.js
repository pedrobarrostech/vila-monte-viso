      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _index2.default.Product.find({
              where: {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            ...
            _context5.next = 7;
            return _index2.default.Product.create(product);
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 3:
            ...
            _context7.next = 6;
            return _index2.default.Product.destroy({
              where: {
                id: req.params.productId
              }
            });
